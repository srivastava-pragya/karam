...
<html>
 ...
 <body onload="window.print();s">
   <div id="outer" style="height:500px;width:670px;border:10px solid orange;">
   <img src="images/logo.png" style="margin-left:20px; margin-top:20px;"/>
    <center>
     <table border="1" style="border-collapse:collapse;text-align:left;">
	   ...
	   <tr>
	     <th>Designation</th>
		 <td><input type="text" name="designation" value="<?php echo $desig;?>" style="height:20px;width:300px"readonly /></td>
	   </tr>
	   <tr>
